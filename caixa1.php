...
<section id="menu" class="section menu">
    ...
    <div class="container">
        <div class="jt_row jt_row-fluid row">
            ...
            $sql = "select * from pedidos where status = 2 and loja = 1 group by pedido order by id asc";
...
<section id="menu" class="section menu">
    ...
    <div class="container">
        <div class="jt_row jt_row-fluid row">
            ...
            <?php
            require("admin/connections/conn.php");
            $sql = "select * from pedidos where status = 3 and loja = 1 group by pedido order by id asc";
            $result = mysqli_query($conn, $sql);
            $resulttotal = mysqli_num_rows($result);
