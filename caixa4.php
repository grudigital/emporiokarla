...
<section id="menu" class="section menu">
    ...
    <div class="container">
        <div class="jt_row jt_row-fluid row">
            ...
            $sql = "select * from pedidos where status = 2 and loja = 4 group by pedido order by id asc";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<form method='post' action='functions/confirmarpagamento4.php'>";
...
<section id="menu" class="section menu">
    ...
    <div class="container">
        <div class="jt_row jt_row-fluid row">
            ...
            <?php
            require("admin/connections/conn.php");
            $sql = "select * from pedidos where status = 3 and loja = 4 group by pedido order by id asc";
            $result = mysqli_query($conn, $sql);
            $resulttotal = mysqli_num_rows($result);
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<form method='post' action='functions/entregarpedido4.php'>";
                echo "<input type='hidden' name='pedido' value='$row[pedido]'>";
